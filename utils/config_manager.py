...
This module is responsible for loading and providing access to the configuration
settings defined in the config.yaml file. It uses the PyYAML library to parse
the YAML configuration file and provides a simple interface to access the
