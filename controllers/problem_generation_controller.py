...
class ProblemGenerationController:
    ...
    def _update_ui_with_problem(self, customers: List[Customer], contractors: List[Contractor], contractor_rate: float):
    ...
    def on_generate_problem(self, event):
        try:
            ...
            self._update_ui_with_problem(customers, contractors, contractor_rate)
